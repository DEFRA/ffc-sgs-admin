...
async function listFiles (dir) {
  ...
  '/root:/' + dir + ':/children'
    ...
    // console.log('List files from SharePoint', JSON.parse(result.payload.toString()))
    return JSON.parse(result.payload.toString()).value
  } catch (err) {
    console.log(err)
    return null
  }
...
module.exports = { setup, uploadFile, listFiles }
